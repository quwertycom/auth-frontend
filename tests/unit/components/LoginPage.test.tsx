...
describe('LoginPage', () => {
  ...
  describe('form validation', () => {
    ...
    it('validates username format', () => {
      ...
      fireEvent.click(loginButton);
      expect(screen.getByText('Only letters, numbers, - and _ allowed')).toBeInTheDocument();
      ...
      fireEvent.click(loginButton);
      expect(screen.queryByText('Only letters, numbers, - and _ allowed')).not.toBeInTheDocument();
    });
